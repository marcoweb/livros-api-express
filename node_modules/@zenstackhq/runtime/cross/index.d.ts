 ...
 */
declare const PrismaWriteActions: readonly ["create", "createMany", "createManyAndReturn", "connectOrCreate", "update", "updateMany", "upsert", "connect", "disconnect", "set", "delete", "deleteMany"];
/**
 * Prisma write operation kinds
 */
