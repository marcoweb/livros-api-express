...
export declare class PolicyUtil extends QueryUtils {
     ...
     */
    getZodSchema(model: string, excludePasswordFields?: boolean, kind?: 'create' | 'update' | undefined): z.ZodObject<any, z.UnknownKeysParam, z.ZodTypeAny, {
        [x: string]: any;
    }, {
        [x: string]: any;
    }> | undefined;
     ...
     */
    validateZodSchema(model: string, kind: 'create' | 'update' | undefined, data: object, excludePasswordFields: boolean, onError: (error: ZodError) => void): object | undefined;
    /**
