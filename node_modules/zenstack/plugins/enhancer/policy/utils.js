 ...
 */
function generateConstantQueryGuardFunction(sourceFile, model, kind, value) {
 ...
 */
function generateQueryGuardFunction(sourceFile, model, kind, allows, denies, forField, fieldOverride = false) {
    const statements = [];
...
function generateEntityCheckerFunction(sourceFile, model, kind, allows, denies, forField, fieldOverride = false) {
    const statements = [];
